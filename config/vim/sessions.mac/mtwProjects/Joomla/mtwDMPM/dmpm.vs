...
silent only
cd ~/mtwProjects/Joomla/mtwDMPM/trunk
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 CHANGELOG
badd +24 ~/mtwProjects/Joomla/mtwDMPM/trunk/mtwDMPM.xml
badd +27 ~/mtwProjects/Joomla/mtwDMPM/trunk/admin/admin.mtwdmpm.php
badd +14 ~/mtwProjects/Joomla/mtwDMPM/trunk/admin/install.mtwdmpm.php
badd +1 ~/mtwProjects/Joomla/mtwDMPM/trunk/admin/uninstall.mtwdmpm.php
badd +1 ~/mtwProjects/Joomla/mtwDMPM/trunk/admin/sql/install.sql
badd +0 ~/mtwProjects/Joomla/mtwDMPM/trunk/admin/sql/uninstall.sql
badd +3 ~/mtwProjects/Joomla/mtwDMPM/trunk/admin/ps_dineromail.php
badd +0 ~/mtwProjects/Joomla/mtwDMPM/trunk/admin/ps_dineromail.cfg.php
args CHANGELOG
edit CHANGELOG
...
1
normal! 0
tabedit ~/mtwProjects/Joomla/mtwDMPM/trunk/mtwDMPM.xml
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
15
normal! 032l
tabedit ~/mtwProjects/Joomla/mtwDMPM/trunk/admin/install.mtwdmpm.php
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 14 - ((7 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
14
normal! 0
tabedit ~/mtwProjects/Joomla/mtwDMPM/trunk/admin/ps_dineromail.php
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
3
normal! 0
tabedit ~/mtwProjects/Joomla/mtwDMPM/trunk/admin/ps_dineromail.cfg.php
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
2
normal! 0
tabedit ~/mtwProjects/Joomla/mtwDMPM/trunk/admin/uninstall.mtwdmpm.php
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
22
normal! 0
tabedit ~/mtwProjects/Joomla/mtwDMPM/trunk/admin/sql/install.sql
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
1
normal! 0104l
tabedit ~/mtwProjects/Joomla/mtwDMPM/trunk/admin/sql/uninstall.sql
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
