...
silent only
cd ~/mtwProjects/Joomla/mtwMultiple/releases
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +4 mtwMakeComponent
badd +15 ~/mtwProjects/Joomla/mtwMultiple/trunk/mtwmultiple.xml
badd +1 ~/mtwProjects/Joomla/mtwMultiple/trunk/admin/controllers/sites.php
badd +0 ~/mtwProjects/Joomla/mtwMultiple/trunk/admin/models/sites.php
args mtwMakeComponent
edit mtwMakeComponent
...
4
normal! 013l
tabedit ~/mtwProjects/Joomla/mtwMultiple/trunk/mtwmultiple.xml
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
15
normal! 0
tabedit ~/mtwProjects/Joomla/mtwMultiple/trunk/admin/controllers/sites.php
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
1
normal! 0
tabedit ~/mtwProjects/Joomla/mtwMultiple/trunk/admin/models/sites.php
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 200 - ((14 * winheight(0) + 20) / 41)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
200
