...
silent only
cd ~/Desktop/Joomla/components/Fireboard/SMF_to_FB
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 mysql.php
badd +37 ~/Desktop/Joomla/components/Fireboard/SMF_to_FB/index.php
args mysql.php
edit ~/Desktop/Joomla/components/Fireboard/SMF_to_FB/index.php
...
silent! normal! zE
let s:l = 107 - ((0 * winheight(0) + 24) / 49)
